...
<div class="row">
	...
	<div class="col-sm-8">
		<?php
            echo" <div ><div id='cover_img'>
            <img  class='img-rounded' src='cover/$user_cover' alt='cover' width='800px' height='325px'>
         </div><form action='profile.php?u_id=$user_id' method='post' accept-charset='utf-8' enctype='multipart/form-data'>
...
<br>
    ...
    <div id='own_posts'>
    	...
    	<div class='row'>
    		<div class='col-sm-12'>
    			<h3><strong><p>$content</p></strong></h3>
							<img id='posts-img' src='imagepost/$upload_image' style='height:350px;'>
    		</div>
    	</div><br>
    	<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-success'>View</button></a>
